...
const plans: Plan[] = [
  {
    id: "free",
    name: "Free",
    description: "Open-source leashd, plus one workspace",
    price: 0,
    interval: "month",
    features: [
      "leashd, self-hosted",
  ...
  },
  {
    id: "pro",
    name: "Pro",
    description: "For developers running serious agent swarms",
    price: 29,
    interval: "month",
    features: [
  ...
  },
  {
    id: "team",
    name: "Team",
    description: "Shared policy and audit across a team",
    price: 99,
    interval: "month",
    features: [
      "Everything in Pro",
