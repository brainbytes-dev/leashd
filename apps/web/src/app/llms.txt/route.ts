...
## Key facts
- Positioning: Non-custodial spend governance for AI agents. Hard budgets, allowlists, audit trail. Lightning, Cashu and x402/USDC, on-chain enforced where the rail allows.
- Category: AI agent payment governance, spend control, policy gate, MCP tool
- Rails: Lightning (NWC / L402), Cashu ecash, x402/USDC on Base and Ethereum. On-chain enforced where the rail allows.
