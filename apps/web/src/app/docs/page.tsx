...
function Step({
  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col gap-4 font-mono text-sm leading-relaxed text-muted-foreground">
        {children}
      </CardContent>
    </Card>
  );
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="mx-auto flex max-w-[44rem] flex-col gap-12 px-4 py-20">
          <header className="flex flex-col gap-4">
            ...
            <p className="font-mono text-base leading-relaxed text-muted-foreground">
              ...
              You hold the keys; {BRAND} holds the policy. The control plane
              (this dashboard) authors signed policies and stores a
              tamper-evident audit log. The local daemon,{" "}
              <span className="text-foreground">leashd</span>, runs on your
              machine, verifies each policy signature, and gates every payment
          ...
          <section className="flex flex-col gap-4">
            ...
            <p className="font-mono text-sm leading-relaxed text-muted-foreground">
              {BRAND} never holds your funds and never sees your keys. The
              dashboard stores only policies and the audit log. Enforcement
              happens locally in{" "}
              <span className="text-foreground">leashd</span>: it pulls the
              signed policy, verifies it, and authorises, caps, or denies each
              spend on the spot. If the control plane is unreachable,{" "}
              <span className="text-foreground">leashd</span> keeps enforcing
              the last verified policy, so your agent is never unleashed by an
              outage.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p className="font-mono text-sm leading-relaxed text-muted-foreground">
              ...
              <span className="text-foreground">leashd</span>) runs on your
              machine and holds your wallet connection locally. The rulebook and
              logbook live in this dashboard.
            </p>
            <p className="font-mono text-sm leading-relaxed text-muted-foreground">
              A concrete run: your research agent wants to pay 50 sat for an API
              call.
            </p>
            <ol className="flex list-decimal flex-col gap-2 pl-5 font-mono text-sm leading-relaxed text-muted-foreground">
              <li>
                The agent never gets your wallet. It gets a policy-gated{" "}
                <span className="text-foreground">pay</span> tool over MCP that
                points at <span className="text-foreground">leashd</span>.
              </li>
              <li>
                The agent calls{" "}
                <span className="text-foreground">pay 50 sat to api.foo.com</span>.
              </li>
              <li>
                <span className="text-foreground">leashd</span> checks your
                policy locally: allowlisted recipient, under the per-transaction
                max, daily budget remaining, kill-switch off.
              </li>
              <li>
            ...
            <p className="font-mono text-sm leading-relaxed text-muted-foreground">
              ...
              itemised statement for your AI. Even a fully compromised agent, or
              a breach of {BRAND} itself, cannot move funds, because the keys
          ...
          <section className="flex flex-col gap-4">
            ...
            <Step n={1} icon={KeyRound} title="Create a workspace and agent">
              <p>
                ...
                <span className="text-foreground">leashd</span> uses to
                authenticate.
              </p>
            ...
            <Step n={2} icon={ShieldCheck} title="Set a policy">
              <p>
                ...
                <span className="text-capped">capped</span>; an endpoint outside
                the allowlist is <span className="text-deny">denied</span>. The
                control plane signs the policy and{" "}
                <span className="text-foreground">leashd</span> verifies the
                signature before enforcing it.
              </p>
              <Code>{`{
        ...
        "LEASH_API_URL": "https://leashd.dev"
            ...
            <Step n={4} icon={Cable} title="Spend is now policy-gated">
              <p>
                ...
                <span className="text-foreground">leashd</span>, which
                authorises (<span className="text-allow">allowed</span>),
                throttles (<span className="text-capped">capped</span>), or
                blocks (<span className="text-deny">denied</span>) it against
                the verified policy. Each decision lands in your signed audit
                feed.
              </p>
              <Button asChild>
